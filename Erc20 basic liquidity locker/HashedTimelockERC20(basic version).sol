...
*
* This contract provides a way to create and keep HTLCs for IERC20 tokens.
*
...
contract HashedTimelockIERC20 {
    ...
    event HTLCIERC20Refund(bytes32 indexed contractId);
     ...
     * @param _tokenContract IERC20 Token contract address.
        ...
        returns (bool)
    {
        ...
        emit HTLCIERC20Refund(_contractId);
        return true;
    }
